...
<link rel="stylesheet" href="css/aggiunteProve.css">
    ...
    <section class="featured-artist-area section-padding-100 bg-img bg-overlay bg-fixed" style="background-image: url(img/bg-img/bg-4.jpg);">
        <div class="container spaziatura283">
            <div class="row align-items-end">
            	<div id = "centrale28">
                <div class="col-12 col-md-5 col-lg-4 margin0">
                    <div class="featured-artist-thumb">
                        <img src="img/bg-img/fa.jpg" alt="">
                    </div>
                </div>
            	<div class=" spaziatura283 col-12 col-md-7 col-lg-8 margin0">
                ...
                <div class="col-12 col-md-7 col-lg-8">
                    <div class="featured-artist-content">
                        <div id = "playMusica" class="song-play-area">
                            ...
                            <i class='fas fa-random controls margineDestro'></i>
                            <i class= "fas fa-step-backward controls margineDestro"></i>
                            <!-- <i id = "playButton" class="fas fa-play controls"></i> -->
                            <i class="fas fa-step-forward controls margineSinistro"></i>
                            <i class='fas fa-sync-alt controls margineSinistro'></i>
                        </div>
                    </div>
                </div>
                </div>
                
			<div class = "spaziatura282 col-12 col-md-7 col-lg-8 margin0">
                <div  id = "canzoniAlbum28">
