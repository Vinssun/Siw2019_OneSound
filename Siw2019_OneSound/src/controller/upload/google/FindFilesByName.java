...
public class FindFilesByName {
    ...
    public static final List<File> getGoogleFilesByName(String path, String fileNameLike) throws IOException {
        ...
        String query = " name contains '" + fileNameLike + "' " //
        		...
        		+" and '1eOJjmITWQWNy5H8MlJkANc_OAGmKVu1s' in parents";
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<File> rootGoogleFolders = getGoogleFilesByName(" ",".jpg");
